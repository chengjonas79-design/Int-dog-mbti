...
const questions = [
  ...
  // === S/N（感知方式）===
  { id:"S1", dim:"SN", q:"带TA去一个没来过的公园，TA会：", A:"每棵树、每根电线杆都要闻一遍，不放过任何角落", B:"四处张望几秒，然后直奔看起来最好玩的地方", scoreA:{S:1}, scoreB:{N:1}},
  { id:"S2", dim:"SN", q:"给TA一个从没见过的新玩具：", A:"先闻闻、舔舔、小心翼翼地试咬，摸索着玩", B:"直接叼起来甩、踩、扔……自创一套玩法", scoreA:{S:1}, scoreB:{N:1}},
  { id:"S3", dim:"SN", q:"你假装扔球（其实藏在手里），TA：", A:"嗖一下冲出去，跑到一半才发现上当——每次都信", B:"看了你一眼没动，好像在说'你手里不是还攥着呢吗'", scoreA:{S:1}, scoreB:{N:1}},
  { id:"S4", dim:"SN", q:"你把TA的食盆/窝挪了个位置，TA会：", A:"一进房间就发现了：咦怎么变了？？", B:"随便吧，反正找到就行", scoreA:{S:1}, scoreB:{N:1}},
  ...
  { id:"J2", dim:"JP", q:"你拿出牵引绳准备出门，TA通常：", A:"两秒内冲到门口，坐好等着，蓄势待发", B:"看心情：有时飞奔过来，有时趴着不动装死", scoreA:{J:1}, scoreB:{P:1}},
  { id:"J3", dim:"JP", q:"玩'叼回来'之类的游戏，TA更像：", A:"按流程走：叼来-放下-再来，循环到底", B:"叼了就跑、中途改道、突然挖土……规则是啥？", scoreA:{J:1}, scoreB:{P:1}},
