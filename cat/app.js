...
const questions = [
  ...
  { id:"E4", dim:"EI", q:"家里来了新的猫/狗（或你带TA去朋友家），TA更像：", A:"主动走过去闻闻对方，试图社交", B:"炸毛/躲远，需要好几天才慢慢接受", scoreA:{E:1}, scoreB:{I:1}},
  ...
  { id:"S3", dim:"SN", q:"你把TA的猫砂盆/饭碗换了个位置，TA：", A:"站在原来的位置一脸困惑，绕了好几圈才找到", B:"随便嗅两下就找到了，适应得很快", scoreA:{S:1}, scoreB:{N:1}},
  { id:"S4", dim:"SN", q:"窗外飞过一只鸟/飞虫，TA：", A:"盯着目标一动不动，嘴巴发出「咔咔咔」的声音，全神贯注", B:"看了两眼就没兴趣了，除非那东西的飞行轨迹特别奇怪", scoreA:{S:1}, scoreB:{N:1}},
  ...
  { id:"J2", dim:"JP", q:"TA睡觉的位置：", A:"基本固定在那一两个地方，换了就不太自在", B:"今天床上，明天纸箱，后天洗衣机上面——随缘", scoreA:{J:1}, scoreB:{P:1}},
  { id:"J3", dim:"JP", q:"TA的「发疯时刻」（猫咪跑酷）：", A:"基本可以预测，每天差不多那个时间段开始", B:"完全随机——可能凌晨三点，也可能午饭后，毫无规律", scoreA:{J:1}, scoreB:{P:1}},
